...
Dock minimalista, ultra rápido y **compilado nativamente en C**:
- ⚡ **Binario nativo compilado**: Rendimiento instantáneo y ligero en memoria.
- 🕒 **Reloj en formato 24 horas** (`HH:MM`).
- 🔕 **Modo No Molestar (DND)** interactivo con `swaync` (󰂚 Normal en blanco / 󰂛 DND en rojo).
...
```bash
sudo pacman -S gcc make pkgconf gtk3 gtk-layer-shell swaync
```
